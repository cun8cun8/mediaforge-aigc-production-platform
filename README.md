# MediaForge P-1 Technical Spike
...
```powershell
python -m mediaforge_p1.provider_probe --provider comfyui --workflow data/workflows/comfyui_image_workflow.json
...
[staged planning](docs/staged-planning.md) for setup and deployment boundaries.
...
[production deployment](docs/production-deployment.md#monitoring-and-alert-routing).
...
are documented in [production deployment](docs/production-deployment.md).
...
[production deployment](docs/production-deployment.md#备份与恢复演练).
